...
CREATE USER 'blog_service'@'%' IDENTIFIED BY 'blog_service888';
ALTER USER 'blog_service'@'%' IDENTIFIED WITH mysql_native_password BY 'blog_service888';
...
# insert user
INSERT INTO `blog_service`.`blog_auth`(`id`, `app_key`, `app_secret`, `created_on`, `created_by`, `modified_on`, `modified_by`, `deleted_on`, `is_del`) VALUES (1, 'test', 'test001', 0, 'test01', 0, '', 0, 0);
